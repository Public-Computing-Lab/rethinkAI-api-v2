...
def download_latest_pdf(base_url: str = "https://www.dotnews.com/inprint/", output_dir: Optional[Path] = None) -> Optional[Path]:
    """
    ...
    print("Step 3: Fetching monthly archive page...")
    try:
    ...
    print("Step 5: Fetching issue page...")
    try:
