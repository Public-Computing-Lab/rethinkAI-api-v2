# RethinkAI - Experiment 4

## Plotly Dashboard

This experiment uses the Plotly Dash framework to present a public safety dashboard using data from the BPD and BOS:311
...
```sh
EXPERIMENT_4_PORT=<port>
EXPERIMENT_4_DASH_REQUESTS_PATHNAME=/ #URL path for 
```
